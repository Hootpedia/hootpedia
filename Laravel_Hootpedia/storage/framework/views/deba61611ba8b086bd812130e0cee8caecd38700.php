...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            <?php if(Route::has('login.blade.php')): ?>
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/home')); ?>" class="text-sm text-gray-700 underline">Home</a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login.blade.php')); ?>" class="text-sm text-gray-700 underline">Login</a>
...
<?php /**PATH C:\Users\durew\hootpedia\Laravel_Hootpedia\resources\views/welcome.blade.php ENDPATH**/ ?>